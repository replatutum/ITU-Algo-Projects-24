...
void bubbleSort(std::vector<Tweet>& tweets, const std::string& sortBy, bool ascending = true);
void insertionSort(std::vector<Tweet>& tweets, const std::string& sortBy, bool ascending = true);
void mergeSort(std::vector<Tweet>& tweets, int left, int right, const std::string& sortBy, bool ascending = true);
